                ...
                setTimeout(async () => {
                    ...
                    setTimeout(async () => {
                        ...
                        if (!jeu_author || !jeu_opponent) {
                            ...
                            bot.functions.addCoins(bot, message, args, message.author.id, mise, 'coins')
                            bot.functions.addCoins(bot, message, args, opponent.user.id, mise, 'coins')
                            return;
                        }
                        ...
                        if(authorBalanceUpdate) bot.functions.addCoins(bot, message, args, message.author.id, authorBalanceUpdate, 'coins')
                        if(opponentBalanceUpdate) bot.functions.addCoins(bot, message, args, opponent.user.id, opponentBalanceUpdate, 'coins')
